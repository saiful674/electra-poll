  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://electra-poll-server.vercel.app/send-message",
        {
    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="custom-scrollbar h-[350px] overflow-auto scroll-smooth mb-4 p-2 bg-slate-100 rounded duration-300"
        >
          <>
