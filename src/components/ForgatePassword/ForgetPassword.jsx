...
const ForgetPassword = () => {
  ...
  const onSubmit = data => {
    passwordReset(data.email)
      .then(() => {
        Swal.fire('Password reset email sent successfully. Check your email and change your password');
        reset()
        navigate("/login");
      })
      .catch(error => {
          ...
          <div className="">
            ...
            <h3 className='text-xl font-bold text-center mb-4'>Reset Password</h3> 
              ...
              <div className="form-control mt-6">
                <input type="submit" className="btn px-3.5 py-2  cursor-pointer border-b-4 border-l-2 active:border-green-600 active:shadow-none shadow-lg bg-gradient-to-tr from-green-500 to-green-400 border-green-600 text-white" value={'Reset Password'} />
              </div>
