            ...
            <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6 bg-gray-100'>
                            ...
                            {elections.map((election, index) => (
                                <SwiperSlide key={index} >
                                    <div className='mb-4'>
                                        ...
                                        <p className='text-red-400'>Voting end: {election.endDate}</p>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper> :
                ...
                <div className='flex-1 bg-white sm:mb-4 text-slate-700 p-8 mb-4 '>
                    ...
                    {ongoingElection.length > 0 ?
                            ...
                            {ongoingElection.map((election, index) => (
                                <SwiperSlide key={index} >
                                    <div className='mb-4'>
                                        ...
                                        <h3 className='text-2xl font-semibold'> {election.title}</h3>
                        ...
                        </Swiper> : <div className=' flex justify-center items-center'  >
                            <Lottie className='w-52 ' animationData={noFoundData} loop={true} />
                        </div>
                    }
                </div>
