    ...
    <section className="my-container mb-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
        <div className="text-center">
          <MdOutlineVpnKey className="h-16 w-16 color-green-dark mx-auto" />          
        ...
        <div className="text-center">
          <AiOutlineMobile className="h-16 w-16 color-green-dark mx-auto" />          
        ...
        <div className="text-center">
          <RxAccessibility className="h-16 w-16 color-green-dark mx-auto" />          
        ...
        <div className="text-center">
          <BsPieChart className="h-16 w-16 color-green-dark mx-auto" />          
        ...
        <div className="text-center">
          <HiOutlineLockClosed className="h-16 w-16 color-green-dark mx-auto" />          
        ...
        <div className="text-center">
          <MdSupportAgent className="h-16 w-16 color-green-dark mx-auto" />          
