  ...
  return (
    <section className="my-container mb-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
        ...
        <div className="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="250"  >
        ...
        <div className="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300"   >
        ...
        <div className="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="350"  >
        ...
        <div className="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400"  >
        ...
        <div className="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="450"  >
