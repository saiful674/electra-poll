...
const TestimonialCard = ({ testimonial }) => {
  return (
    <div data-aos="fade-left" data-aos-duration="1400" data-aos-once="true" className="text-center h-96 flex justify-center items-center  bg-gray-50 rounded-lg p-5 shadow-lg border-l">
      <div>
