    ...
    return (
        <section className='my-container mb-20'>
            ...
            <div className='mt-10 grid grid-cols-2 md:grid-cols-5 gap-5 items-center off-white'>
                <figure data-aos="fade-up" data-aos-duration="800" data-aos-delay="200"  >
                    <img src={companyLogo1} alt="our connected companies logo" />
                </figure>
                <figure data-aos="fade-up" data-aos-duration="800" data-aos-delay="250"  >
                    <img src={companyLogo2} alt="our connected companies logo" />
                </figure>
                <figure data-aos="fade-up" data-aos-duration="800" data-aos-delay="300"  >
                    <img src={companyLogo3} alt="our connected companies logo" />
                </figure>
                <figure data-aos="fade-up" data-aos-duration="800" data-aos-delay="350"  >
                    <img src={companyLogo4} alt="our connected companies logo" />
                </figure>
                <figure data-aos="fade-up" data-aos-duration="800" data-aos-delay="400"  >
